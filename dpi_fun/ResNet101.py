...
def Model(input_shape, num_classes):
    ...
    # ResNet-34
    x = make_advanced_block_layer(x, filter_num=64, blocks=3)
    x = make_advanced_block_layer(x, filter_num=128, blocks=4, stride=2)
    x = make_advanced_block_layer(x, filter_num=256, blocks=23, stride=2)
    x = make_advanced_block_layer(x, filter_num=512, blocks=3, stride=2)
